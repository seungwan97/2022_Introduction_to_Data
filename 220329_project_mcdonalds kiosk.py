                                        ...
                                        while y==0:
                                            ...
                                            while cus:  # 폼4.customize
                                                if cus == "사이드추가":
                                                    ...
                                                    print("선택안함/선택완료")
                                                    print("주문내역:", order_list)
                                                    if (sd[0:10] in order_list) and (sd[10:] in order_list):
                                                        print("세트할인가 반영")
                                                        pay_list.append(-1000*int((sd[0:10] in order_list) and (sd[10:] in order_list)))
                                                        print("합계:%d원" % int(sum(pay_list)))
                                                        break
                                                        y=y+1
                                                    else:
